...
const demoList = [
  { title: 'Vertical Layout', to: 'https://demos.pixinvent.com/vuexy-vuejs-laravel-admin-template/demo-1/dashboards/analytics' },
...
<template>
  <div class="footer">
    ...
    <div class="footer-line w-100">
      <VContainer>
        <div class="d-flex justify-center align-center py-2 text-body-1 text-white-variant">
          &copy; {{ new Date().getFullYear() }} نظام إدارة التحاليل والخدمات الطبية المنزلية - جميع الحقوق محفوظة.
        </div>
      </VContainer>
    </div>
  </div>
