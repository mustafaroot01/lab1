...
const initMap = async () => {
  ...
  map = L.map('branch-add-map').setView([33.3128, 44.3615], 11)
  ...
  <div>
    ...
    <div class="d-flex flex-wrap justify-start justify-sm-space-between gap-y-4 gap-x-6 mb-6">
      <div class="d-flex flex-column justify-center">
        <div class="d-flex align-center gap-2 mb-1">
          ...
          <h4 class="text-h4 font-weight-medium">
            إضافة فرع جديد وتحديد التغطية
          </h4>
        </div>
        <div class="text-body-1 text-medium-emphasis">
          إدخال معلومات الفرع ورسم نطاق الخدمة الميداني وتحديد أوقات العمل الأسبوعية
        </div>
      </div>
      ...
      <div class="d-flex gap-3 align-center flex-wrap">
        ...
        <VBtn color="primary" prepend-icon="tabler-check" :loading="loading" @click="submitBranch">
          حفظ الفرع
        </VBtn>
      </div>
    </div>
