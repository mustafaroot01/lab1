...
class MessageCreated implements ShouldBroadcastNow
{
    ...
    public function broadcastWith(): array
    {
        ...
        $this->message->conversation->loadMissing(['patient:id,name,phone,district_id,area_id', 'patient.district:id,name_ar', 'patient.area:id,name_ar', 'assignedTo:id,name']);
